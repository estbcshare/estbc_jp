...
<?php endif; ?>
			...
			<div class="list-right fr">
				...
				<div class="search-box relativ clearfix">
							...
							<input type="text" name="s" placeholder="欲しいものを検索...">
							<button></button>
							</form>
		...
		<div class="m-section-2">
			...
			<div class="m-wrap">
				...
				<div class="m-title-box flex-wrap" style="margin-top:0;">
					...
					<span class="m-name">関連セクション</span>
...
<li>
					<a href="<?php the_permalink() ?>">
						<div class="img-M-BOX">
								<div class="m-bg"></div>
							<img src="<?php if ( has_post_thumbnail() ) { ?><?php $full_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full');echo $full_image_url[0];?><?php } else {?><?php echo catch_first_image() ?><?php } ?>" alt="<?php the_title(); ?>" alt="">
...
$(".m-d-swiper .swiper-slide").each(function(){
	if($(".m-d-swiper .swiper-slide").length>0)
	{
