...
class ashu_meta_box{   
    ...
    function add_script_and_styles(){   
        ...
        {      
			...
			$theme_dir2=get_bloginfo('template_url');

            wp_enqueue_style('metabox_fields_css', $theme_dir2. '/includes/metabox_fields.css');   

            wp_enqueue_script('metabox_fields_js',$theme_dir2. '/includes/metabox_fields.js');   
