...
<div class="container">    
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
              <div class="list_box"><h2 class="left_h1">新闻中心</h2>
                    <div class="contents">
...
<?php $rand_posts = get_posts('post_type=news&numberposts=6&orderby=rand');foreach($rand_posts as $post) : ?> 
<li><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a><span class="news_time"><?php the_time('Y-m-d G:i:s'); ?></span></li>
<?php endforeach;?>
